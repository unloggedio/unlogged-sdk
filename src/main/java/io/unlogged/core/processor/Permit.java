...
public class Permit {
    ...
    private static final sun.misc.Unsafe UNSAFE = (sun.misc.Unsafe) reflectiveStaticFieldAccess(sun.misc.Unsafe.class,
            "theUnsafe");
    ...
    public static void handleReflectionDebug(Throwable t, Throwable initError) {
        ...
        System.err.println(
                "** LOMBOK REFLECTION exception: " + t.getClass() + ": " + (t.getMessage() == null ? "(no message)" : t.getMessage()));
