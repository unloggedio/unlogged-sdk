...
class Target:
	def __init__(self, test_repo_url, test_repo_name, rel_dependency_path, rel_main_path, buildSystem, test_response = [], custom_start_command = ""):
		...
		self.custom_start_command=custom_start_command
