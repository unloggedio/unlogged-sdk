...
//        System.out.println("Original value: " + originalResponseString);
    ...
    @Test
    void arrangeMocksMatchFailed() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        AgentCommandExecutorImpl agentCommandExecutor = new AgentCommandExecutorImpl(objectMapper,
                new DiscardEventLogger());
...
//        System.out.println("Expected value: " + objectMapper.writeValueAsString(expectedValue));
        ...
        String mockedResponseString = objectMapper.writeValueAsString(returnedValue);
//        System.out.println("Mocked value: " + mockedResponseString);
        Assertions.assertFalse(mockedResponseString.contains("9988"));
        Assertions.assertFalse(mockedResponseString.contains("mockedStringResponse"));
...
//        System.out.println("Original value: " + originalResponseString);
    ...
    @Test
    void arrangeMockInterfaceField() throws Exception {

        ObjectMapper objectMapper = new ObjectMapper();
        AgentCommandExecutorImpl agentCommandExecutor = new AgentCommandExecutorImpl(objectMapper,
                new DiscardEventLogger());

        JpaFieldUserService simpleServiceA = new JpaFieldUserService();
...
//        Optional<Authority> expectedValue = simpleServiceA.callToTest("a val", new SimplePojoB("1", 1));
//        System.out.println("Expected value: " + objectMapper.writeValueAsString(expectedValue));

        JpaFieldUserService simpleServiceAWithMocks = (JpaFieldUserService) agentCommandExecutor.arrangeMocks(
                simpleServiceA.getClass(),
                simpleServiceA.getClass().getClassLoader(),
                simpleServiceA, declaredMocks);
        ...
        try {
            Optional<Authority> returnedValue = simpleServiceAWithMocks.callToTest("a val", new SimplePojoB("1", 1));
            Assertions.fail();
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Exception class: " + e.getClass().getCanonicalName());
